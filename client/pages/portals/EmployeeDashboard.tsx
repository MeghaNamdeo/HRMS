      ...
      <main className="flex-1 p-4 lg:p-8 mt-16 lg:mt-0">
        <div className="max-w-6xl">
          ...
          <Card className="border-slate-200 mt-6">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div>
                  <p className="text-sm text-slate-600 mb-2">Casual Leave</p>
                  <div className="flex items-end gap-2">
                    <p className="text-2xl font-bold text-slate-900">8</p>
                    <p className="text-sm text-slate-500">/ 12 days</p>
                  </div>
                ...
                <div>
                  <p className="text-sm text-slate-600 mb-2">Sick Leave</p>
                  <div className="flex items-end gap-2">
                    <p className="text-2xl font-bold text-slate-900">6</p>
                    <p className="text-sm text-slate-500">/ 8 days</p>
                  </div>
                  <div className="w-full bg-slate-200 rounded-full h-2 mt-2">
                ...
                <div>
                  <p className="text-sm text-slate-600 mb-2">PTO (Paid Time Off)</p>
                  <div className="flex items-end gap-2">
                    <p className="text-2xl font-bold text-slate-900">4</p>
                    <p className="text-sm text-slate-500">/ 5 days</p>
                  </div>
                  <div className="w-full bg-slate-200 rounded-full h-2 mt-2">
                ...
                <div>
                  <p className="text-sm text-slate-600 mb-2">Unpaid Leave</p>
                  <div className="flex items-end gap-2">
          ...
          <Card className="border-slate-200 mt-6">
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-4 border border-slate-200 rounded-lg hover:border-primary hover:bg-slate-50 transition-colors">
                  <div className="text-2xl font-bold text-primary">25</div>
                  <div className="flex-1">
                    <p className="font-semibold text-slate-900">Year-End Review</p>
                ...
                <div className="flex items-start gap-4 p-4 border border-slate-200 rounded-lg hover:border-primary hover:bg-slate-50 transition-colors">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-slate-900">Salary Review Cycle</p>
                ...
                <div className="flex items-start gap-4 p-4 border border-slate-200 rounded-lg hover:border-primary hover:bg-slate-50 transition-colors">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-slate-900">Form-16 Available</p>
