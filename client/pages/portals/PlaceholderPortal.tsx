      ...
      <main className="flex-1 p-4 lg:p-8 mt-16 lg:mt-0">
        <div className="max-w-4xl">
          ...
          <div className="text-center py-16">
            ...
            <Card className="border-slate-200 max-w-2xl mx-auto mb-8">
              <CardHeader>
              ...
              <CardContent className="text-left">
                <ul className="space-y-3">
                  {info.features.map((feature, index) => (
                    <li
                      key={index}
                      className="flex items-start gap-3 p-3 border border-slate-200 rounded-lg hover:border-primary hover:bg-slate-50 transition-colors"
                    >
