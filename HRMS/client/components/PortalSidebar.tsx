  ...
  const configs = {
    ...
    hr_admin: {
      ...
      items: [
        ...
        { icon: Users, label: "User Management", href: "/portal/hr_admin/users" },
        { icon: UserPlus, label: "Employee Management", href: "/portal/hr_admin/employees" },
        { icon: Briefcase, label: "Recruitment (ATS)", href: "/portal/hr_admin/recruitment" },
        { icon: Clock, label: "Attendance", href: "/portal/hr_admin/attendance" },
        { icon: Calendar, label: "Leave Management", href: "/portal/hr_admin/leave" },
        { icon: DollarSign, label: "Payroll & Finance", href: "/portal/hr_admin/payroll" },
        { icon: TrendingUp, label: "Performance (PMS)", href: "/portal/hr_admin/performance" },
        { icon: BookOpen, label: "L&D (LMS)", href: "/portal/hr_admin/lms" },
        { icon: Receipt, label: "Expenses", href: "/portal/hr_admin/expenses" },
        { icon: HardDrive, label: "Asset Management", href: "/portal/hr_admin/assets" },
        { icon: Shield, label: "Compliance", href: "/portal/hr_admin/compliance" },
        { icon: Bell, label: "Notifications", href: "/portal/hr_admin/notifications" },
        { icon: BarChart3, label: "Reports & Analytics", href: "/portal/hr_admin/reports" },
        { icon: Bot, label: "Automation & AI", href: "/portal/hr_admin/ai" },
      ],
    },
    finance_admin: {
      name: "Finance Portal",
...
export function PortalSidebar() {
  ...
  return (
    <>
      {/* Mobile Menu Button */}
      <div className="fixed top-0 left-0 right-0 z-40 lg:hidden bg-background border-b border-border px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className={`w-10 h-10 rounded-lg bg-gradient-to-br ${roleConfig.color} flex items-center justify-center`}>
            <RoleIcon className="w-6 h-6 text-white" />
          </div>
          <span className="font-bold text-foreground">HRMSuite</span>
        </div>
        <button
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-0 z-30 lg:relative lg:translate-x-0 lg:h-screen w-64 bg-background border-r border-border transition-transform duration-300 ${isOpen ? "translate-x-0" : "-translate-x-full"
